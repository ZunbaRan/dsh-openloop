...
async function apply(ctx, config) {
	await new McpRuntimeService(ctx, config).start();
}
var src_default = {
	name,
	inject,
...
//#endregion
export { MCP_APP_MAX_BYTES, MCP_APP_MIME, McpRuntime, McpRuntimeError, McpRuntimeService, appContentSecurityPolicy, apply, asJsonObject, src_default as default, defaultMcpConnectionFactory, inject, isRecord, isUiResourceUri, name, validateAppHtml, validateAppMetadata, validateAppResource, validateUiBinding };
