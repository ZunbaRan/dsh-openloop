...
//#endregion
//#region src/index.ts
const Config = Schema.object({ allowLoopbackOrigins: Schema.array(Schema.string()).default([]) });
const OPENLOOP_SETTINGS_NAMESPACE = "openloop-visuals";
...
function apply(ctx, config) {
	...
	ctx.inject(["webServer"], (webCtx) => {
		...
		webCtx.effect(() => registerBaseFetchRoute(webCtx, webCtx.webServer, { allowedOrigins: config.allowLoopbackOrigins }), "openloop-base: fetch proxy route");
	});
}
//#endregion
export { Config, DEFAULT_OPENLOOP_SETTINGS, OPENLOOP_GLOBAL_TOKENS, OPENLOOP_PRESETS, OPENLOOP_PRESET_IDS, OPENLOOP_SETTINGS_NAMESPACE, PRESET_META, apply, decodeOpenLoopSettings, name, paletteVariables, resolvePalette };
