...
if (forbidden.length > 0) {
  throw new Error(`Panels client bundle imports modules unavailable to the DSH browser loader: ${forbidden.join(', ')} (${fileURLToPath(bundleUrl)})`)
}

console.log(`Verified panels client bundle imports: ${[...new Set(requires)].sort().join(', ')}`)
