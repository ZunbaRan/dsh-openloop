...
export default [
  {
    ...
    deps: { neverBundle: ['@deepseek-ai/cordis', '@openloop/dsh-mcp-runtime', '@openloop/dsh-mcp-tools', '@openloop/dsh-mcp-apps'] },
  },
  {
    entry: { client: 'src/client/index.tsx' }, outDir: 'lib', format: 'cjs', platform: 'browser', dts: false, clean: false,
    deps: {
      neverBundle: externals,
      alwaysBundle: ['@openloop/dsh-mcp-apps/**', '@modelcontextprotocol/ext-apps/**', '@modelcontextprotocol/sdk/**'],
    },
